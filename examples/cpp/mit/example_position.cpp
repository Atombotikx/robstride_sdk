...
int main() {
    ...
    std::cout << "Starting High-Frequency MIT Position Control. Press Ctrl+C to stop." << std::endl;
    ...
    while (transport->is_connected() && keep_running) {
        ...
        auto res5 = motor5.send_mit_control(0.0f, target, 0.0f, Kp, Kd);
        ...
        auto res6 = motor6.send_mit_control(0.0f, target, 0.0f, Kp, Kd);
